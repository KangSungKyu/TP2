...
# 메인 프로그래머 최신 사양 (공용 1~8번, 특수 패턴 10~13번)
garon_states_config = [
    (1, "Garon_Idle"),
    (2, "Garon_Move"),
    (3, "Garon_Jump"),
    (8, "Garon_Death"),
    (10, "Garon_Pattern_OverheadSmash"),
    (11, "Garon_Pattern_ComboSlash"),
    (12, "Garon_Pattern_Charge"),
    (13, "Garon_Pattern_Shockwave")
]
...
print("Successfully updated GaronAnimatorController.controller for Pattern States 10~13!")
