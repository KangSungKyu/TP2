...
# Complete YAML for Room_TestDummy Chunk Prefab
room_yaml = """%YAML 1.1
...
room_guid = f"r{hash('Room_TestDummy_Prefab') & 0xffffffffffffffff:031x}"
with open(meta_p, "w", encoding="utf-8") as f:
    f.write(f"fileFormatVersion: 2\nguid: {room_guid}\nPrefabImporter:\n  externalObjects: {{}}\n  userData: \n  assetBundleName: \n  assetBundleVariant: \n")

print(f"Successfully generated Room_TestDummy.prefab at {prefab_p}!")
