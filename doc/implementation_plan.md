...
| 2026-08-11 | Stage 1~4 전체 스테이지 리소스 확장 리스트업, Spine 2D vs Sprite Sheet 단가 비교(Spine 2D 60% 절감 선정), AI 생성을 활용한 880만원대 파이프라인 리서치 수립 | `doc/specs/full_game_art_resource_and_ai_pipeline_spec.md` 신설 |
